  ...
  <table id="myTable" width="90%" border="1">
    ...
    ?>
      ...
      <tr>
        ...
        <td><?php echo $i++?></td>
        <td id="get-<?php echo $id?>-6"><img src="<?php echo $row->image?>" style="width:60px;height:60px; border-radius: 25%; border:1px solid grey;"></td>
        <td id="get-<?php echo $id?>-1"><?php echo $row->firstname?></td>
        <td id="get-<?php echo $id?>-2"><?php echo $row->lastname?></td>
        <td id="get-<?php echo $id?>-3"><?php echo $row->email?></td>
        <td id="get-<?php echo $id?>-4"><?php echo $row->designation?></td>
        <td id="get-<?php echo $id?>-5"><?php echo $row->dob?></td>
